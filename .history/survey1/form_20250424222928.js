...
function onSubmitSurvey1() {
    ...
    const requiredFields = [
        ...
        { id: 'form_answer20', name: 'パスワード' },
        { id: 'form_answer21', name: 'パスワード確認' },
        { id: 'form_answer02', name: '携帯電話番号' },
        { id: 'form_answer03', name: '姓' },
        { id: 'form_answer04', name: '名前' },
        { id: 'form_answer05', name: 'フリガナ（姓）' },
        { id: 'form_answer06', name: 'フリガナ（名）' },
        { id: 'form_answer07', name: '生年月日（年）' },
        { id: 'form_answer08', name: '生年月日（月）' },
        { id: 'form_answer09', name: '生年月日（日）' },
        { id: 'form_answer10', name: '大学名' },
        { id: 'form_answer11', name: '部活名' },
        { id: 'form_answer12', name: '学年' },
        { id: 'form_answer13', name: '性別' },
        { id: 'form_answer14', name: '出身地' },
        { id: 'form_answer15', name: '役職' },
        { id: 'form_answer16', name: '学部' },
        { id: 'form_answer17', name: '学科' },
        { id: 'form_answer18', name: '学習形態' },
        { id: 'form_answer19', name: '個人情報同意' }
    ];
...
// 関数をグローバルスコープに公開
window.createSurvey1Form = createSurvey1Form;
